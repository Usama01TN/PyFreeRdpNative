#!/usr/bin/env python3
"""
Validate a staged pyfreerdpnative native package: pyfreerdpnative/_libs (+ _bin).
...
def main():
    ...
    p.add_argument("--libs", default=os.path.join(repo_root(), "pyfreerdpnative", "_libs"))
    ...
    tmp = tempfile.mkdtemp(prefix="pyfreerdpnative-validate-")
